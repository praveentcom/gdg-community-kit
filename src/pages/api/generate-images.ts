...
export default async function handler(
  ...
  try {
    ...
    await resend.emails.send({
      ...
      html: `<p>Hey ${`${fullName}`.split(" ")[0]} 👋🏼<br/><br/>We've successfully generated branding assets for <strong>${communityParsed} ${location}</strong> community. Use this <a href="${signedUrl}" target="_blank">hosted link</a> to download the kit (the link will remain valid for 30 days).<br/><br/>We wish you and your community to scale heights. Found the tool useful? Consider leaving a star on <a href="https://github.com/praveentcom/gdg-community-kit" target="_blank">GitHub</a>.<br/><br/>♥️<br/>Thanks,<br/>Praveen.</p>`,
    });
