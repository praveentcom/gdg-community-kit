...
function Element({
  ...
  return (
    ...
    >
      <img
        src={`${process.env.BASE_URL}/images/base/brand/website-banners/640x500/${colorVariant}/base_image${getImageVariantSuffix(imageVariant)}.png`}
        alt="Brand Logo"
        style={{
          width: "100%",
          height: "100%",
...
export default function getBrandWebsiteBanner640x500({
  location,
  colorVariant,
  dimensions,
  fontColor,
