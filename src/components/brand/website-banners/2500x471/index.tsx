...
function Element({
  ...
  return (
    ...
    >
      ...
      <img
        src={`${process.env.BASE_URL}/images/base/brand/website-banners/2500x471/${colorVariant}/base_image${getImageVariantSuffix(imageVariant)}.png`}
        alt="Brand Logo"
        style={{
          width: "100%",
          height: "100%",
...
export default function getBrandWebsiteBanner2500x471({
  location,
  colorVariant,
  dimensions,
  fontColor,
