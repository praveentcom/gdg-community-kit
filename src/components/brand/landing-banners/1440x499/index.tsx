...
function Element({
  ...
  return (
    ...
    >
      ...
      <img
        src={`${process.env.BASE_URL}/images/base/brand/landing-banners/1440x499/${colorVariant}/base_image${getImageVariantSuffix(imageVariant)}.png`}
        alt="Brand Logo"
        style={{
          width: "100%",
          height: "100%",
...
export default function getBrandLandingBanner1440x499({
  location,
  colorVariant,
  dimensions,
  fontColor,
