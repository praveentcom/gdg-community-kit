...
function Element({
  ...
  return (
    ...
    >
      <img
        src={`${process.env.BASE_URL}/images/base/brand/email-header/${colorVariant}/base_image${getImageVariantSuffix(imageVariant)}.png`}
        alt="Brand Logo"
        style={{
          width: "100%",
          height: "100%",
...
export default function getBrandEmailHeader({
  location,
  colorVariant,
  dimensions,
  fontColor,
